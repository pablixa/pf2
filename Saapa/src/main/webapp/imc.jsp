        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <div class="panel-body">
                    ...
                    <img src="images/graficos/imc/<c:out value='${usuario.getMatricula()}'/>Imc.png" width="700" height="600" alt="grafico"/></c:forEach>  
                <input type="hidden"  id="cls"name="cls" value="${ac.classificaImc(param.matricula)}">
                ...
                <div id="mensagem" class="label ">
                    Risco de complicação metabólica: <span id="span" class="active ">${ac.classificaImc(param.matricula)}   </span>
                </div>
            </div>
