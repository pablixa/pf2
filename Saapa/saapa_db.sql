...
--
-- Host: 127.0.0.1
-- Generation Time: 19-Jun-2017 às 18:16
...
INSERT INTO `aluno` (`matricula`, `Usuario_id_Usuario`) VALUES
(1, 33),
(12, 35);
...
CREATE TABLE IF NOT EXISTS `avaliacao` (
  ...
  `subAxiliar` double DEFAULT NULL,
  ...
  `metaQ` double DEFAULT NULL,
  `metaC` double DEFAULT NULL,
  `metaP` double DEFAULT NULL,
  `id` int(11) NOT NULL,
  `Aluno_idAluno` int(11) NOT NULL,
  `Professor_Cref` int(11) NOT NULL
...
INSERT INTO `avaliacao` (`peso`, `altura`, `quadril`, `cintura`, `torax`, `subAxiliar`, `triceps`, `abdominal`, `coxa`, `subescapular`, `suprailiaca`, `dataAtual`, `dataRenovacao`, `metaQ`, `metaC`, `metaP`, `id`, `Aluno_idAluno`, `Professor_Cref`) VALUES
(100, 190, 100, 20, 20, 20, 20, 20, 30, 20, 20, '2017-06-19', '2017-06-19', 120, 56, 100, 6, 1, 12341),
(100, 190, 120, 70, 10, 20, 20, 20, 10, 20, 20, '2017-06-19', '2017-06-19', 120, 56, 100, 7, 1, 12341),
(100, 170, 100, 100, 129, 19, 19, 19, 19, 19, 19, '2017-06-19', '2017-06-19', 50, 50, 50, 8, 1, 12341);
...
INSERT INTO `cidade` (`Cod_IBGE`, `nome`, `UF`) VALUES
...
CREATE TABLE IF NOT EXISTS `endereco` (
  ...
  `Cidade_Cod.IBGE` int(11) NOT NULL,
...
INSERT INTO `endereco` (`cep`, `logradouro`, `complemento`, `Cidade_Cod.IBGE`, `idEndereco`) VALUES
('1', '1', '2', 1200013, 47),
('21.212-121', '12', 'complem', 2700102, 48);
...
INSERT INTO `exercicio` (`idExercicio`, `nome`, `tipo`) VALUES
(4, 'teste', 'teste');
...
INSERT INTO `ficha` (`id_ficha`, `Aluno_idAluno`) VALUES
(10, 1);
...
INSERT INTO `professor` (`Cref`, `Usuario_id_Usuario`) VALUES
(12341, 34);
...
INSERT INTO `treino` (`carga`, `repeticao`, `descanso`, `dataAtual`, `dataRenovacao`, `TreinoID`, `ficha_id_ficha`) VALUES
(10, 4, 10, '2017-06-19', '2017-12-12', 3, 10);

-- --------------------------------------------------------

--
-- Estrutura da tabela `treino_has_exercicio`
--

CREATE TABLE IF NOT EXISTS `treino_has_exercicio` (
  `Treino_TreinoID` int(11) NOT NULL,
  `Exercicio_idExercicio` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `treino_has_exercicio`
--

INSERT INTO `treino_has_exercicio` (`Treino_TreinoID`, `Exercicio_idExercicio`) VALUES
(3, 4);
...
INSERT INTO `usuario` (`id_Usuario`, `nome`, `cpf`, `dtNascimento`, `email`, `senha`, `Endereco_idEndereco`, `telefone`, `sexo`, `status`) VALUES
(33, 'PABLO', '696.283.123-20', '1995-11-19', 'EMAIL@EMAIL.OM', '1234', 47, '(61) 9874-1234', 'm', 1),
(34, 'PROFESSOR 1 ', '696.123.321.32', '1995-11-19', 'EMAIL@EMAIL.COM', '33', 47, '(61) 9874-1234', 'm', 1),
(35, 'teste', '333.333.333-33', '1990-02-12', 'email@email.com', '223', 48, '(33)3333-3333', 'm', 0);
...
ALTER TABLE `aluno`
  ...
  ADD KEY `fk_Aluno_Usuario1_idx` (`Usuario_id_Usuario`);
...
ALTER TABLE `avaliacao`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_Avaliacao_Aluno1_idx` (`Aluno_idAluno`),
  ADD KEY `fk_Avaliacao_Professor1_idx` (`Professor_Cref`);
...
ALTER TABLE `endereco`
  ...
  ADD KEY `fk_Endereco_Cidade1_idx` (`Cidade_Cod.IBGE`);
...
ALTER TABLE `estagiario`
  ...
  ADD KEY `fk_Estagiario_Usuario1_idx` (`Usuario_id_Usuario`);
...
ALTER TABLE `ficha`
  ...
  ADD KEY `fk_ficha_Aluno1_idx` (`Aluno_idAluno`) USING BTREE;
...
ALTER TABLE `professor`
  ...
  ADD KEY `fk_Professor_Usuario1_idx` (`Usuario_id_Usuario`);

--
-- Indexes for table `treino`
--
ALTER TABLE `treino`
  ADD PRIMARY KEY (`TreinoID`),
  ADD KEY `fk_Treino_ficha1_idx` (`ficha_id_ficha`);

--
-- Indexes for table `treino_has_exercicio`
--
ALTER TABLE `treino_has_exercicio`
  ADD PRIMARY KEY (`Treino_TreinoID`,`Exercicio_idExercicio`),
  ADD KEY `fk_Treino_has_Exercicio_Exercicio1_idx` (`Exercicio_idExercicio`),
  ADD KEY `fk_Treino_has_Exercicio_Treino1_idx` (`Treino_TreinoID`);
...
ALTER TABLE `usuario`
  ...
  ADD KEY `fk_Usuario_Endereco_idx` (`Endereco_idEndereco`);
...
--
ALTER TABLE `endereco`
  MODIFY `idEndereco` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=49;
--
-- AUTO_INCREMENT for table `estagiario`
--
ALTER TABLE `estagiario`
  MODIFY `ID_Estagiario` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `exercicio`
--
ALTER TABLE `exercicio`
  MODIFY `idExercicio` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `treino`
  MODIFY `TreinoID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `aluno`
  ADD CONSTRAINT `fk_Aluno_Usuario1` FOREIGN KEY (`Usuario_id_Usuario`) REFERENCES `usuario` (`id_Usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `avaliacao`
--
ALTER TABLE `avaliacao`
  ADD CONSTRAINT `fk_Avaliacao_Aluno1` FOREIGN KEY (`Aluno_idAluno`) REFERENCES `aluno` (`matricula`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Avaliacao_Professor1` FOREIGN KEY (`Professor_Cref`) REFERENCES `professor` (`Cref`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `endereco`
--
ALTER TABLE `endereco`
  ADD CONSTRAINT `fk_Endereco_Cidade1` FOREIGN KEY (`Cidade_Cod.IBGE`) REFERENCES `cidade` (`Cod_IBGE`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `estagiario`
--
ALTER TABLE `estagiario`
  ADD CONSTRAINT `fk_Estagiario_Usuario1` FOREIGN KEY (`Usuario_id_Usuario`) REFERENCES `usuario` (`id_Usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `ficha`
--
ALTER TABLE `ficha`
  ADD CONSTRAINT `fk_ficha_Aluno1` FOREIGN KEY (`Aluno_idAluno`) REFERENCES `aluno` (`matricula`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `professor`
--
ALTER TABLE `professor`
  ADD CONSTRAINT `fk_Professor_Usuario1` FOREIGN KEY (`Usuario_id_Usuario`) REFERENCES `usuario` (`id_Usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `treino`
--
ALTER TABLE `treino`
  ADD CONSTRAINT `fk_Treino_ficha1` FOREIGN KEY (`ficha_id_ficha`) REFERENCES `ficha` (`id_ficha`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `treino_has_exercicio`
--
ALTER TABLE `treino_has_exercicio`
  ADD CONSTRAINT `fk_Treino_has_Exercicio_Exercicio1` FOREIGN KEY (`Exercicio_idExercicio`) REFERENCES `exercicio` (`idExercicio`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Treino_has_Exercicio_Treino1` FOREIGN KEY (`Treino_TreinoID`) REFERENCES `treino` (`TreinoID`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `usuario`
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `fk_Usuario_Endereco` FOREIGN KEY (`Endereco_idEndereco`) REFERENCES `endereco` (`idEndereco`) ON DELETE NO ACTION ON UPDATE NO ACTION;
